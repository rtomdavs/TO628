...
What we can do after finding out which of our predictors are used in our best model, we can look at the averages of all of the columns given just students who were predicted to graduate vs. those who were predicted to dropout. We can see that the average 2nd semester approved credits of those students predicted to dropout is around below 4. The value of those predicted to graduate, however, is above 4. What we recommend to the Institute is an *early intervention program*. If they notice any student whose 2nd semester approved credits are below 4, they reach out to them for academic counseling.

Students who were predicted to dropout also have a higher incidence of being in the Basic Education or Agronomy courses of study. We recommend the Institute bolster their support for these departments in general, through either improving counseling specifically or modes of instruction.

In terms of financial characteristics, students who were predicted to dropout had higher rates of being debtors but having their tuition fees up to date. This might seem paradoxical, but we believe that 

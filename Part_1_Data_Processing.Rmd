...
**Our solution**
For each categorical feature with this problem, we will group the trivial levels to create an aggregated dummy variable called "Others". We define any levels with less than 5% of total values, or top 3 levels with most values (if these is only one levels with more than 5%), as trivial. 

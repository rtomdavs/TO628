...
pbenr <- ifelse(logenrolled >= 0.5, 1, 0)
...
Whereas the actual rate of graduation is around 61%. The true utility comes from analyzing what of these predicted enrolled students have in common. For that we can reference our 
